...
class Grid(object):
    ...
    def start_grid(self, mid_point):
        ...
        self.stop_loss_buy = self.grid_mid - (get_tick_size(self.instrument) * (get_grid_spacing() * 6))
        ...
        self.stop_loss_sell = self.grid_mid + (get_tick_size(self.instrument) * (get_grid_spacing() * 6))
